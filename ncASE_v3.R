...
###modifying here to deal with new format
z <- rbind(x,y)
duplicates <- z[duplicated(paste(z[,1],z[,2])),]
...
#modified to deal with new counts here:
snps <- snps[(snps$species_1_species_1+0.01)/(snps$species_2_species_1+0.01) > 0.9
                   & (snps$species_1_species_1+0.01)/(snps$species_2_species_1+0.01) < 1.1
                   & (snps$species_1_species_2+0.01)/(snps$species_2_species_2+0.01) > 0.9
                   & (snps$species_1_species_2+0.01)/(snps$species_2_species_2+0.01) < 1.1,]

#exclude zeros
snps <- snps[snps$species_1_species_1 > 0 & snps$species_1_species_2 > 0 & snps$species_2_species_1 > 0 & snps$species_2_species_2 > 0,]
